...
# ------- CNN with dropout regularized techniques 
NAME = "Chile_normal_vs_disease_dropout-{}".format(int(time.time()))
...
history2 = model.fit_generator(train_datagen.flow(X_train, y_train, batch_size=32),
...
# save the model
model.save('CNN_dropout_Chile_Disease_vs_Normal_2')
